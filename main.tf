...
# Module      : S3 SRR Replication
# Description : Terraform module which configures SRR
resource "aws_s3_bucket" "destination" {
  bucket = "tf-test-bucket-destination-12345-brylex"
  region = "us-east-1"
...
resource "aws_s3_bucket" "source" {
  bucket   = "tf-test-bucket-12345-brylex"
  region   = "us-west-2"
